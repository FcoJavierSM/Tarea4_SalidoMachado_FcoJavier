...
import dam.pmdm.spyrothedragon.VideoPlayerActivity
...
class WorldsAdapter(
    ...
    private val resetTaps = Runnable { tapCount = 0 }
    ...
    override fun onBindViewHolder(holder: WorldsViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            if (tapCount >= 3) {
                tapCount = 0
                it.context.startActivity(Intent(it.context, VideoPlayerActivity::class.java))
            } else {
                tapHandler.postDelayed(resetTaps, 500)
            }
        }
    }
